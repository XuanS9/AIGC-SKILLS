...
For stills used as video keyframes or storyboard references, pass framing, subject position, gaze, screen direction and light into [shared director planning](narrative-planning.md). Select views for the required event or reveal; a framing option does not impose a cut or duration. Standalone still-image composition remains governed by the full reference below.
