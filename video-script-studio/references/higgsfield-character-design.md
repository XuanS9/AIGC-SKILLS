...
本项目的角色资产执行 [角色资产交付规范](template-character-asset-delivery.md)，其默认约定优先：左侧正面面部特写，右侧无头部的全身正面、侧面、背面，按需在右下方补充服装、配饰或道具的关键细节局部图。干净浅色背景，左右分区清晰，局部细节与主视图一致。正面定稿为身份主参考，其他面部角度按需单独补充并核对身份；人物参考不自动充当视频首帧。
