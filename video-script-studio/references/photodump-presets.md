...
> `IMAGE-MODEL-SPECS.md` (generated from the dated `models_explore`
> image snapshot in `model-specs.json`, `image-model-specs.json`, and `audio-model-specs.json`). The preset CATALOG below stays hand-maintained —
